...
describe('Make Delivery Collected (E2E)', () => {
  ...
  test('[PUT] /deliveries/:id/collected', async () => {
    ...
    const response = await request(app.getHttpServer())
      .patch(`/deliveries/${deliveryId}/collected`)
    ...
    expect(deliveryOnDatabase.collectedAt).toBeTruthy()
  })
})
